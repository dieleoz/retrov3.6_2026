...
1. Probar la app de usuario 0.3.7 (`RETRO-COVIANDINA-usuario-0.3.7-10.apk`) en dos teléfonos (Android ≤9 y
   ≥10) (B7) y despacharla al funcional (Julio) con la instrucción de instalación directa sin desinstalar.
