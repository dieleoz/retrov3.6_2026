...
// V3.6: sin 'static'; son los valores de fabrica y calibracion_v36.c los sustituye por los de EEPROM
double X_2 = 0.0;
double X_1 =  0.00043212;
double X_0 = 0.90148651;   // para pruebas debe quedar X_2=0; X_1=0; X_0=1; y = x + 
...
static int measure(struct pt * pt) {
    ...
    char nivel[6];   // V3.6: era [2]; sprintf("%u") de dos o mas cifras escribia fuera
    char chartemp[5];
    char charHumedad[5];
