...
- **No es el firmware V3 2020**: difiere en 35 763 bytes de la base d089f962. Sus cadenas son las de la familia V4, en 0xff5e-0xffc2: `@LEERV,%d@/n/r`, `***** RETROREFLECTOMETRO VERTICAL *****`, `OFFSET= %0.2f` y `***** NEW SAMPLE *****`. Responde por tanto al protocolo `@LEERV,<COLOR>,<TIPO>@`, no a los bytes sueltos de la V3.
