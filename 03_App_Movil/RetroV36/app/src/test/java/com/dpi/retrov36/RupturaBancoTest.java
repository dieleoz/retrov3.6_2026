...
public class RupturaBancoTest {
    ...
    static Map<String, Integer> simular(Campana c, BancoCola q, boolean reabrir, Map<String, String> corte) throws Exception {
        ...
        for (int guard = 0; guard < 400; guard++) {
            ...
            int[] km = Protocolo.efectivo(p, true, "PRECISO", REP);
    ...
    public static void main(String[] a) throws Exception {
        ...
        for (String p : REP) {
            ...
            System.out.println("   " + p + " elegida " + (s == null ? "-" : s.id + " " + Arrays.toString(Protocolo.deSerie(s))
        ...
        System.out.println("  incumple P67: " + Protocolo.incumple("P67", c5.elegida("P67"), Protocolo.requerido("PRECISO"))
                + ", P43: " + Protocolo.incumple("P43", c5.elegida("P43"), Protocolo.requerido("PRECISO")));
