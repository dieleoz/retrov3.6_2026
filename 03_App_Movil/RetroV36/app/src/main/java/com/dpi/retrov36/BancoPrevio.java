...
public final class BancoPrevio {
    ...
    public static Resultado aplicar(Campana c, BancoCola cola, Grupos g, Decisiones d, String equipo, String fecha)
        ...
        String motivoRep = "repetir en preciso " + ProtocoloDisparos.K_PRECISO + "×" + ProtocoloDisparos.M_PRECISO
        ...
        for (String pat : repetir) {
            ...
            String mal = s == null || s.anulada != null ? null : ProtocoloDisparos.incumple(pat, s, preciso);
            if (mal != null) {
